...
class _TableCalendarState extends State<TableCalendar>
  ...
  Widget _buildHeader() {
        ...
        child: Text(
          widget.headerStyle.titleTextBuilder != null
              ...
              : DateFormat.yMMMM(widget.locale)
                  .format(_calendarLogic.focusedDay),
    ...
    if (widget.builders.headerExtendBuilder != null) {
      children.insertAll(0, widget.builders.headerExtendBuilder());
    }
  ...
  Widget _buildDecorationWrapper({Widget child}) {
